...
- **Karma System**: All logic regarding user reputation, boost/burn reactions, and AI-content penalties is defined in [CARMA.md](./docs/CARMA.md). Always refer to this file when modifying voting components or backend scoring logic.
